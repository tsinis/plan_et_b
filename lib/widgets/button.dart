...
class CyberButton extends StatelessWidget {
  const CyberButton({Key key, this.text = 'O K'}) : super(key: key);
  final String text;
  @override
  Widget build(BuildContext context) => InkWell(
        child: Material(
          ...
          child: Padding(
            ...
            child: Text(text, style: FontEnchantments.displayClean.copyWith(fontSize: 16), textAlign: TextAlign.center),
          ),
        ),
        onTap: () => (text == 'O K')
            ? Navigator.push(
