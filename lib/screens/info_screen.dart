...
class InfoScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    _musicAudioPlayer.open(Audio('assets/audio/cubedcanada+invaderloop.mp3'),
        autoStart: false, volume: 0.4, respectSilentMode: true, showNotification: false);
    return Scaffold(
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              const Expanded(flex: 12, child: Spacer()),
                              Expanded(flex: 3, child: const Text('Plan-et-B', maxLines: 1).glitchText),
                              Tooltip(
                                message: 'There is short delay, please wait for it.',
                                child: RaisedButton(
                                    child:
                                        Text('Play/Stop Music', style: MainScreen.textStyle(const Color(0xFF560631))),
                          ...
                          RaisedButton(
                            ...
                            onPressed: () => Navigator.push(
                              ...
                              CupertinoPageRoute<Route>(
                                  fullscreenDialog: true, builder: (context) => const MainScreen()),
                            ),
                          ),
                          Flexible(
                            child: AutoSizeText(
